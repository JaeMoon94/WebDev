...
/////
    ...
    /////    $checkPassword = "SELECT PASSCODE FROM userInfo WHERE PASSCODE = password('$inputPassword');";
    /////}
/////
/////
...
/////
    ...
    /////$str2 = mysqli_query($conn, $checkPassword);
    /////$password2 ="";
/////
    ...
    //  echo "<p style = 'color: blue;'>".$password2 ."</p>" ;
    //  echo "<p style = 'color: red;'>".$str ."</p>" ;

    // echo var_dump($str)."<br>";
    // echo var_dump($checkPassword )."<br>";
    // echo var_dump($str2);
   ...
   // // {
   // //     if($str == $password2) $isMatch = true;
   // //     else $isUnMatch = true;
   // // }

    if(!empty($inputID) and !empty($inputPassword))
    {
        if($str == $str3) $isMatch = true;
        else $isUnMatch = true;
    }
